...
void QExtendedButton::UpdateStyle()
{
    switch (state) {
    case FLAGGED:
        this->setStyleSheet("border-image: url(:/textures/textures/cellflag.svg) 0 0 0 0 stretch stretch;");
        break;
    case MINE:
        this->setStyleSheet("border-image: url(:/textures/textures/cellmine.svg) 0 0 0 0 stretch stretch;");
        break;
    case BLAST:
